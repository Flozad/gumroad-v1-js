...
const Elsewhere: React.FC = () => {
  ...
  <Layout title="Elsewhere" hideFooter={false} hideHeader={false} showLoginLink={false} loggedIn={false} onLinksPage={false} userBalance={0} bodyId="page-elsewhere">
    <div id="main-content">
      ...
      <p>Download <Link to="/downloads/gumroad.zip">Gumroad for WordPress</Link>, unzip it, and drag it into your wp-content/plugins/ folder. Then, update your Gumroad (under Settings) account details in your WP Admin dashboard.</p>
