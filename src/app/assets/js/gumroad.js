$(document).ready(function () {
  ...
  function pay() {
    ...
    $.post(
      "https://gumroad.appspot.com/api/purchase/",
      {
        id: item_id,
        card_number: cc_number,
        date_month: cc_month,
        date_year: cc_year,
        card_security_code: cc_code,
      },
      function (data) {
        result = data;
        ...
        if (data["status"] == "failure") {
          ...
          $("#gumroad-modal-footer").html(
            '<a href="' +
              data["redirect_url"] +
              '" id="gumroad-modal-pay-button" target="_blank">Download now</a>'
          );
        }
      }
    );
